...
"# AdvReactRedux"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/Persepolis1/AdvReactRedux.git git push -u origin master
